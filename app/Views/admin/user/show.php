...
<p>
    <a href="/admin/user">⬅ Retour à la liste</a> |
    <a href="/admin/user/edit?id=<?= $user['id_user'] ?>">✏ Modifier</a> |
    <a href="/admin/user/delete?id=<?= $user['id_user'] ?>" onclick="return confirm('Supprimer cet utilisateur ?')">🗑 Supprimer</a>
</p>
