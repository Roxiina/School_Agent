<?php 
$title = "Tableau de bord Professeur - School Agent";
    ...
    <main class="main-content">
        ...
        <div class="dashboard-grid">
            <div class="card">
                ...
                <h3>Mes Étudiants</h3>
                <p>Suivez le progrès de vos étudiants et leurs interactions avec les agents IA.</p>
                <a href="?page=user&role=etudiant" class="card-link">
                    Voir mes étudiants <i class="fas fa-arrow-right"></i>
                </a>
            </div>
            ...
            <div class="card">
                ...
                <h3>Conversations</h3>
                <p>Consultez et modérez les conversations entre étudiants et agents IA.</p>
                <a href="?page=conversation" class="card-link">
                    Gérer les conversations <i class="fas fa-arrow-right"></i>
                </a>
            </div>
            ...
            <div class="card">
                ...
                <h3>Matières</h3>
                <p>Gérez le contenu pédagogique et les matières que vous enseignez.</p>
            ...
            <div class="card">
                ...
                <h3>Statistiques</h3>
                <p>Analysez les performances et l'engagement de vos étudiants.</p>
                <a href="?page=stats" class="card-link">
                    Voir les statistiques <i class="fas fa-arrow-right"></i>
                </a>
            </div>
            ...
            <div class="card">
                ...
                <p>Personnalisez les agents IA pour vos besoins pédagogiques.</p>
                <a href="?page=agent&mode=config" class="card-link">
                    Configurer les agents <i class="fas fa-arrow-right"></i>
                </a>
            </div>
            ...
            <div class="card">
                ...
                <p>Adaptez le contenu selon les niveaux de vos étudiants.</p>
